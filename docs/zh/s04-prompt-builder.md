...
![System Prompt 六层组装](../../illustrations/s04-prompt-builder/01-infographic-six-layers.png)
...
![Prompt 缓存策略](../../illustrations/s04-prompt-builder/02-flowchart-cache-strategy.png)
